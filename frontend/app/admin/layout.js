        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="text-gray-600 dark:text-gray-400 font-medium">Verifying admin privileges...</div>
                </div>
            </div>
        );
    }
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div>
                                            ...
                                            <div className={`text-xs ${isActive ? 'text-orange-600/70 dark:text-orange-400/70' : 'text-gray-400 dark:text-gray-500'}`}>
                                                {item.description}
                                            </div>
                                        </div>
                                    </Link>
