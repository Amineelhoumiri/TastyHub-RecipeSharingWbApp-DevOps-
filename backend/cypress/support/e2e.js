...
Cypress.Commands.add('login', (email, password) => {
  return cy.request({
    ...
    if (response.status === 200) {
      ...
      return response; // Return full response object so tests can access status
    }
    return response;
  });
});
...
Cypress.Commands.add('authenticatedRequest', (method, url, body = null, options = {}) => {
  ...
  const requestOptions = {
    ...
    ...options // Merge any additional options (like failOnStatusCode)
  };
