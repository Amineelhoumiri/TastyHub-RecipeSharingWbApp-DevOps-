...
```
*Note: You can provide just `username` OR just `email`, or both*
...
```
**Body:** None  
*Note: This toggles the like (if already liked, it unlikes)*
...
```
**Body:** None  
*Note: This toggles the favorite (if already favorited, it unfavorites)*
...
```
*Note: `comment` is required. `rating` is optional (1-5)*
...
```
*Note: Both fields are optional - include what you want to update*
